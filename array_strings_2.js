...
//   number = number.replace(number[0],lastdigit);
//   console.log(number[0]);
//   number = number.replace(number[number.length -1],firstdigit);
//   return +number;

// }
// let dig = reverseDigits(13);
// console.log(dig)
...
let s = secondBiggest([1, 3, 6, 8], [2, 3, 6, 7]);
...
removeDuplicates([1, 3, 5, 2, 5, 2, 6]);
...
let b = decodeCipher("Olssv dvysk", 7)
